...
func resolveCallerArgs(fnDecl *ast.FuncDecl, call *ast.CallExpr, callerInfo *types.Info, calleeInfo *types.Info) (status string, typeName string, fields []Field, confidence string) {
