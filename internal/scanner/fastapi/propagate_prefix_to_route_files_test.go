...
//ff:what propagatePrefixToRouteFiles: include_router 체인 prefix 전파 수렴
package fastapi
...
func TestPropagatePrefixToRouteFiles(t *testing.T) {
	...
	// users.py's router should have received the propagated prefix
...
func TestPropagatePrefixToRouteFiles_NoFiles(t *testing.T) {
	// empty input converges immediately
