...
//ff:what TestExtractDTO_OmitType_AsConst 테스트
package nestjs
...
func TestExtractDTO_OmitType_AsConst(t *testing.T) {
	dir := t.TempDir()
...
export class UpdateUserReqDto extends OmitType(CreateUserReqDto, ['password'] as const) {}
`)
