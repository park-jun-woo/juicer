...
func TestScan_BasicController(t *testing.T) {
	...
	writeFile(t, dir, "src/main/java/com/example/demo/controller/UserController.java", basicControllerSource)
	writeFile(t, dir, "src/main/java/com/example/demo/dto/CreateUserRequest.java", basicCreateUserDtoSource)
	writeFile(t, dir, "src/main/java/com/example/demo/dto/UserDto.java", basicUserDtoSource)
