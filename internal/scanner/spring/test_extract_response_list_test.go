...
//ff:what TestExtractResponse_ListReturnType — List 반환 타입 추출 테스트
package spring

import "testing"

func TestExtractResponse_ListReturnType(t *testing.T) {
	src := []byte(`
package com.example;
...
public class TestController {
    ...
    @GetMapping("/items")
    public List<ItemDto> getAll() { return null; }
}
`)
	...
	if !ep.returnIsArray {
		t.Error("expected returnIsArray to be true")
	}
}
