...
//ff:what 대입문에서 fiber.New() 또는 Group 호출을 감지하여 라우터를 등록한다
package fiber
...
func processAssign(stmt *ast.AssignStmt, fiberAlias string, routers map[string]*routerInfo) {
